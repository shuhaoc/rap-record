...
public final class SoundTouch
{
    ...
    public native final void setTempo(float tempo);

    public native final void setSampleRate(int srate);

    public native final void putSample(short[] samples);

    public native final short[] receiveSample(int maxSamples);
